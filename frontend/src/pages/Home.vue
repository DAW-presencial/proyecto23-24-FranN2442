<template>
  <div class="container">
    <div class="rounded-div">
      <div class="title-container">
        <div class="title-text">{{ $t('titleHome') }}</div>
      </div>
  ...
  <div class="card-container">
    <h5 class="text-center text-h5" style="font-weight: bold; text-transform: uppercase;">{{ $t('restaurant') }}</h5>
    <div class="card-div">
    ...
    <h5 class="text-center text-h5" style="font-weight: bold; text-transform: uppercase;">{{ $t('offer') }}</h5>
        ...
        <q-carousel v-model="slide" transition-prev="scale" transition-next="scale" swipeable animated
          ...
          <q-carousel-slide name="layers" class="column no-wrap flex-center" img-src="">
            ...
            <div class="q-mt-md text-center">
              <h6 class="text-h6">{{ $t('offer1') }}</h6>
            </div>
          </q-carousel-slide>
          <q-carousel-slide name="style" class="column no-wrap flex-center" img-src="">
            <q-icon name="style" size="56px" />
            <div class="q-mt-md text-center">
              <h6 class="text-h6">{{ $t('offer2') }}</h6>
            </div>
          </q-carousel-slide>
        </q-carousel>
      </div>
    </div>
    <h5 class="text-center text-h5 text-bold text-uppercase">{{ $t('registerRest') }}</h5>
    <div class="card-div">
      <q-card class="restRegister">
        <q-card-section horizontal>
          ...
          <q-card-section class="bg-grey-4">
            ...
            <h6 class="left text-black-9 text-caption" style="font-size: 18px;">{{ $t('joinUsDescription') }}</h6>
            <div class="text-center">
              <q-btn class="custom bg-grey-4" to="/send-mail" :label="$t('joinUsBtn')" />
            </div>
          </q-card-section>
        </q-card-section>
      </q-card>
